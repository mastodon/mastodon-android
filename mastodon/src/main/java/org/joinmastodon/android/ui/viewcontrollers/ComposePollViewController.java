...
public class ComposePollViewController {
    ...
    private final ArrayList<DraftPollOption> pollOptions = new ArrayList<>();
    ...
    public void setView(View view, Bundle savedInstanceState) {
        ...
        View pollDurationButton = pollWrap.findViewById(R.id.poll_duration);
        ...
        View pollStyleButton = pollWrap.findViewById(R.id.poll_style);
    ...
    private class OptionDragListener implements ReorderableLinearLayout.OnDragListener {
        ...
        private final RectF rect1, rect2;
