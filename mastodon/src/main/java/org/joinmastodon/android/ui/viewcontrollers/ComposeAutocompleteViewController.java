...
public class ComposeAutocompleteViewController {
    ...
    private final Runnable usersDebouncer = this::doSearchUsers;
    private final Runnable hashtagsDebouncer = this::doSearchHashtags;
    private String lastText;
    private boolean isLoading;
    private final FilterChipView emptyButton;
    private final HideableSingleViewRecyclerAdapter emptyButtonAdapter;
    ...
    private static class WrappedEmoji {
        ...
        private final ImageLoaderRequest request;
