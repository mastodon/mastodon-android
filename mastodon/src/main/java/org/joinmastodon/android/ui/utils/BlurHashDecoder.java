...
/**
 * <a href="https://github.com/woltapp/blurhash/blob/master/Kotlin/lib/src/main/java/com/wolt/blurhashkt/BlurHashDecoder.kt">BlurHashDecoder.kt</a>
...
public class BlurHashDecoder {
    ...
    private static final SparseArray<double[]> cacheCosinesX = new SparseArray<>();
    private static final SparseArray<double[]> cacheCosinesY = new SparseArray<>();
