...
public class AudioAttachmentBackgroundDrawable extends Drawable {
    ...
    private final long[] animationStartTimes = {0, 0};
    private boolean animationRunning;
    private final Runnable[] restartRunnables = {() -> restartAnimation(0), () -> restartAnimation(1)};
    ...
    public void draw(@NonNull Canvas canvas) {
        ...
        for (long animationStartTime : animationStartTimes) {
            long t = time - animationStartTime;
            if (t < 0)
                continue;
