...
public class AccountSessionManager {
    ...
    private final HashMap<String, AccountSession> sessions = new HashMap<>();
    private final HashMap<String, List<EmojiCategory>> customEmojis = new HashMap<>();
    private final HashMap<String, Long> instancesLastUpdated = new HashMap<>();
    private final HashMap<String, Instance> instances = new HashMap<>();
    private final MastodonAPIController unauthenticatedApiController = new MastodonAPIController(null);
