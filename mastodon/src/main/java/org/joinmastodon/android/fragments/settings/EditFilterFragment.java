...
public class EditFilterFragment extends BaseSettingsFragment<Void> implements OnBackPressedListener {
    ...
    private void updateContextItem() {
        ...
        contextItem.subtitle = switch (values.size()) {
            ...
            case 3 ->
                    getString(R.string.selection_3_options, values.get(0), values.get(1), values.get(2));
            default ->
                    getString(R.string.selection_4_or_more, values.get(0), values.get(1), values.size() - 2);
        };
